  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-600 via-sky-500 to-emerald-400 p-4 dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950">
      <div className="w-full max-w-md rounded-2xl bg-white dark:bg-zinc-900 border border-transparent dark:border-zinc-800 p-6 shadow-2xl sm:p-8">
        ...
        <h2 className="mb-1 text-center text-2xl font-bold text-textDark dark:text-zinc-100">Welcome to YatraAI</h2>
        <p className="mb-8 text-center text-sm text-gray-400 dark:text-zinc-500">Sign in to continue planning</p>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full rounded-lg border bg-white dark:bg-zinc-800 text-gray-900 dark:text-zinc-100 placeholder-gray-400 dark:placeholder-zinc-400 py-2.5 pl-10 pr-4 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-500 ${errors.email ? 'border-red-300 dark:border-red-500/50' : 'border-gray-200 dark:border-zinc-600'
                  }`}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full rounded-lg border bg-white dark:bg-zinc-800 text-gray-900 dark:text-zinc-100 placeholder-gray-400 dark:placeholder-zinc-400 py-2.5 pl-10 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-500 ${errors.password ? 'border-red-300 dark:border-red-500/50' : 'border-gray-200 dark:border-zinc-600'
                  }`}
        ...
        <p className="mt-6 text-center text-sm text-gray-500 dark:text-zinc-400">
          ...
          <Link to="/register" className="font-semibold text-blue-500 hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
  )
